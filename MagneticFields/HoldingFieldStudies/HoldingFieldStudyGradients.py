...
#cp=ax2.pcolor((zs-0.5*dzs)/a,(ys-0.5*dys)/a,Gtot,cmap='jet',vmin=Gtot.min(), vmax=Gtot.max())
cbar=fig.colorbar(cp, ax=ax2)
cbar.ax.set_ylabel(r'$|\nabla B_z|$ (Gauss/cm)', rotation=270,labelpad=15)


ax2.set_title( 'Hemholtz Coil Field Gradients with I=1 amp, a=10 cm, x=0 plane')
ax2.set_xlabel('z/a')
ax2.set_ylabel('y/a')
