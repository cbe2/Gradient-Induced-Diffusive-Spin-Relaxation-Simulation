...
plt.plot(r[:,2]/a,GBz[:,2]/G0) #plot z comp of field along z axis

#plt.semilogy(r[:,2]/a,GBzn)
plt.xlabel("z/a (unitless)")
plt.ylabel(r'$\partial_z B_z/G_z$')
plt.title(r"1000 Amp Hemholtz Coil + 500 Amp Maxwell Coil along the z-axis ")
plt.grid()
plt.show()
